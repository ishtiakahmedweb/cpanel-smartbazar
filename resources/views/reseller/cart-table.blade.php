                ...
                <tr class="cart-table__row" data-id="{{ $product->id }}">
                        ...
                        <td class="cart-table__column cart-table__column--price" data-title="Price">
                            <div class="input-group input-group-sm">
                                <input type="number" class="form-control form-control-sm" min="0"
                                    ...
                                    wire:model.live="retail.{{ $product->id }}.price" />
                    ...
                    <td class="cart-table__column cart-table__column--quantity" data-title="Quantity">
                        <div class="input-number product__quantity">
                            ...
                            <div class="input-number__add" wire:click="increaseQuantity('{{ $product->rowId }}')">
                            </div>
                            <div class="input-number__sub" wire:click="decreaseQuantity('{{ $product->rowId }}')">
                            </div>
                        </div>
                    </td>
