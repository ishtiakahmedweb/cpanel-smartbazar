<div class="dropcart">
    ...
    <div class="dropcart__buttons">
        <a class="btn btn-outline-primary btn-sm d-none" href="#" wire:navigate.hover>View Cart</a>
        <a class="btn btn-primary" href="{{ route('checkout') }}" wire:navigate.hover>Checkout</a>
    </div>
</div><!-- .dropcart / end -->
