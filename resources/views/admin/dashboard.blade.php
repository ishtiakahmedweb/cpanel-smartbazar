...
@push('js')
    ...
    <script>
        ...
        function refresh() {
            ...
            var newStart = window._start.format('YYYY-MM-DD');
            var newEnd = window._end.format('YYYY-MM-DD');

            if (currentParams.get('status') == (window._status || '') &&
                currentParams.get('staff_id') == (window._staff || '') &&
                (currentParams.get('date_type') || 'created_at') == window._type &&
                currentParams.get('start_d') == newStart &&
                currentParams.get('end_d') == newEnd
            ) {
                return;
            }
            ...
            window.location = "{!! route('admin.home', [
                ...
                .replace('_start', newStart).replace('_end', newEnd)
