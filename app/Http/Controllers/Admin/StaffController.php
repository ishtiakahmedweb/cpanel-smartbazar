...
class StaffController extends Controller
{
    ...
    {
        abort_unless(request()->user()->is('admin'), 403, 'You don\'t have permission.');
        abort_if($staff->email == 'support@smartbazarbd.com' && request()->user()->email != 'support@smartbazarbd.com', 403, 'You don\'t have permission.');
    ...
    public function destroy(Admin $staff)
    {
        ...
        abort_if(str_ends_with($staff->email, '@smartbazarbd.com'), 403, 'You cannot delete staff with @smartbazarbd.com email.');
