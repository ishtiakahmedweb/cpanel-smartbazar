...
class Order extends Model
{
    ...
    {
        return Attribute::get(function ($products): mixed {
            $decoded = json_decode((string) $products);
            
            // Ensure each product has a slug property (prevents undefined property errors)
            if (is_array($decoded)) {
