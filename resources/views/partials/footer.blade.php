    ...
    <div class="site-footer">
        <div class="container">
            ...
            <div class="site-footer__bottom">
                ...
                @if(($name = $company->dev_name??'Smart Bazar BD') != '#' and ($link =
                $company->dev_link??'https://smartbazarbd.com') != '#')
                <div class="site-footer__payments">
                    Developed By <a href="{{$company->dev_link??'https://smartbazarbd.com'}}"
                        class="text-danger">{{$company->dev_name??'Smart Bazar BD'}}</a>
                </div>
                @else
                <div class="site-footer__payments">
