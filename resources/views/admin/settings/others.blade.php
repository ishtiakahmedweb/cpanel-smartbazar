    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label for="scroll_text">Scroll Text (Marquee)</label>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label for="topbar_notice">Top Bar Notice (Static)</label>
                <x-textarea name="topbar_notice" id="topbar_notice">{{ $topbar_notice ?? null }}</x-textarea>
                <x-error field="topbar_notice" />
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
