                ...
                <div class="card-body p-3">
                    <x-form method="post" :action="route('admin.slides.store')" id="slides-dropzone" class="dropzone" has-files>
                        <div class="dz-message needsclick">
                            ...
                            <span class="note needsclick">(Recommended <strong>1125x395</strong>px for desktop, <strong>360x180</strong>px for mobile.<br>Main content must be centered for mobile view.)</span>
                        </div>
                    </x-form>
                </div>
            </div>
            ...
            new Dropzone("#slides-dropzone", {
                ...
                init: function () {
                    ...
                    this.on('error', function(file, errorMessage){
                        // Prevent auto-reload on error so user can see what went wrong
